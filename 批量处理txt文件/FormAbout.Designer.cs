namespace 批量处理txt文件
{
	partial class FormAbout
	{
		...
		private void InitializeComponent()
		{
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::批量处理txt文件.Properties.Resources.show;
			...
			this.label2.Text = "此工具方便夫人提高日常工作效率";
			// 
			// linkLabel1
			// 
			this.linkLabel1.AutoSize = true;
			this.linkLabel1.Location = new System.Drawing.Point(278, 128);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(125, 12);
			this.linkLabel1.TabIndex = 3;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Text = "http://www.fuyue.xyz";
			...
			this.label3.Text = "更便捷高效的处理手头事务";
			// 
			// label4
			// 
			this.label4.AutoSize = true;
			this.label4.Location = new System.Drawing.Point(191, 103);
			this.label4.Name = "label4";
			this.label4.Size = new System.Drawing.Size(125, 12);
			this.label4.TabIndex = 5;
			this.label4.Text = "更多信息访问请官网：";
			// 
			// FormAbout
			// 
